...
// Function to add "+" insted of whitespace --- used to take the weather description and to put it into the query
// in order to search for an image with that description
